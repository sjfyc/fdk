...
#pragma warning(default: 4996)
	...
	{
		g_HGE.Rectangle(center.x-extend.x, center.y-extend.y,
			center.x+extend.x, center.y+extend.y, color);
	}
	...
	{
		return cellCoordToLocation(cellCoord)+Location(HALF_CELL_SIZE_X, HALF_CELL_SIZE_Y);
	}
