#ifndef __FDK_BINARYHEAP_H_INCLUDE__
#define __FDK_BINARYHEAP_H_INCLUDE__
#include "Base.h"
#include <set>
#include <stdlib.h>
...
namespace fdk
{
	...
	template<class T,class _PrTaxis,bool _enableRandom>
	inline bool BinaryHeap<T,_PrTaxis,_enableRandom>::empty() const
	{
		return m_size == 0;
	}
